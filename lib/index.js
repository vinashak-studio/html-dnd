...
exports.code = util.format(
  `(function(draggable, droppable, dndSimulateConfig) {
    %s;
...
exports.codeForSelectors = util.format(
  `(function(selectorDraggable, selectorDroppable, dndSimulateConfig) {
    %s;
...
exports.codeForXPaths = util.format(
  `(function(selectorDraggable, selectorDroppable, dndSimulateConfig) {
    %s;
