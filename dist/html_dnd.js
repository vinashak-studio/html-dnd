...
(function (dnd) {
  ...
  function simulate(draggable, droppable, dndSimulateConfig) {
    var dragPosition = calculateMousePositions(draggable, dndSimulateConfig && dndSimulateConfig.dragOffset);
    var store = new DragDataStore();
    // For the dragstart event. New data can be added to the drag data store.
    store.mode = "readwrite";
    var dataTransfer = new DataTransfer(store);
    var dragstartEvent = createEventWithDataTransfer(
      "dragstart",
      dataTransfer,
      0,
      0,
    ...
    var dragOverEvent1 = createEventWithDataTransfer(
      "dragover",
      dataTransfer,
      0,
      0,
    ...
    var dropPosition = calculateMousePositions(droppable, dndSimulateConfig && dndSimulateConfig.dropOffset);
    var dragOverEvent2 = createEventWithDataTransfer(
      "dragover",
      dataTransfer,
      0,
      0,
    ...
    store.mode = "readonly";
    var dropEvent = createEventWithDataTransfer("drop", dataTransfer, 0, 0, 0, dropPosition.x, dropPosition.y, false, false, false, false, 0, null);
    ...
    var dragendEvent = createEventWithDataTransfer(
      "dragend",
      dataTransfer,
      0,
      0,
   ...
   */
  function calculateMousePositions(element, offset) {
